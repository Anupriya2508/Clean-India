...
<div class="wrapper">
    <header><br>
        ...
        <div class="one">
        <br><br><br><br><br><br><br><pre><p align="center"style= "color:black; font-size:20px; font:Algerian; background-color:white">Address : Chennai Municipal Corporation,
        No: 26 K. B Nagar ,
        Chennai-600020.
        Tamil Nadu </p> 
        <p align="center"style= "color:black; font-size:20px; font:Algerian">Toll Free No : 1800-233-0265</p>
        <p align="center"style= "color:black; font-size:20px; font:Algerian">Email: municipal@gmail.com</p> 
                </div>  
                </div>
            </pre>
