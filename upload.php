...
You can upload a picture in format with maximum 5MB and video in format with maximum 10MB.</p>
				<br><br>
				...
				<div class="form-group">
					<label for="fileup" class="col-sm-2 control-lebal">Image  / Video</label>
					<div class="col-sm-10">
						<input type="file" accept="video/* ,image/*" name="file" id="fileup" /><div id="output"></div>
